...
function drawTile(ctx, room, cam, { alpha = 1, fall = 0, label = "", time = 0, state = null } = {}) {
  ...
  const useLoadedBiomeArtSurface = !isHubRoom && hasLoadedBiomeArenaArt(room, 'surface');

import { getDefaultHubMaskLayout, isHubMaskPointWalkable } from './hub/hubWalkMask.js';
...
export function isPointInHub(x, y, pad = 0) {
  const maskHit = isHubMaskPointWalkable(null, x, y, {
    pad,
    layoutOverride: getDefaultHubMaskLayout({ cx: 0, cy: 0, side: HUB_HALF * 2 }),
  });

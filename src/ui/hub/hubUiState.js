export const BUILD_BRANCH_META = {
  all: {
    ...
    intro: "The hub no longer pushes every system into one wall of cards. Each platform now opens its own focused screen: Skill Master for card growth, Essence for crystals and exchange, Mastery for passive doctrine, Forge for materials and gear.",
    accent: "#8fd8ff",
  },
  arsenal: {
    label: "Skill Master",
    title: "Skill Master • Card Growth",
    hint: "Upgrade and evolve owned skill cards for the active hero.",
    intro: "This station is now dedicated to card growth. Pick one owned skill card, raise its level with Gold + biome Essence, then evolve it with Essence and 3 exact copies of the same star rank.",
    accent: "#80d7ff",
  },
  essence: {

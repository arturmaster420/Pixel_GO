  ...
  if (showEssences) for (const key of BIOME_ESSENCE_KEYS) {
    ...
    const chip = make("div", {
      ...
      style: {
        ...
        alignItems: "center",
        gap: compact ? "6px" : "7px",
        padding: isHubHud ? "7px 9px" : (compact ? "6px 9px" : "7px 10px"),
        borderRadius: chipBase.borderRadius,
        border: `1px solid ${meta.accent}66`,
        background: isHubHud ? `linear-gradient(180deg, ${meta.accent}2f, rgba(12,16,24,0.96))` : `${meta.accent}18`,
        color: "#eef8ff",
        fontSize: isHubHud ? "11px" : (compact ? "11px" : "12px"),
        boxShadow: isHubHud ? chipBase.boxShadow : `0 0 0 1px ${meta.accent}18 inset`,
        fontWeight: chipBase.fontWeight || '400',
      },
    });
  ...
  if (showCardEconomy) {
    ...
    wrap.appendChild(make("div", {
      ...
      style: {
        ...
        background: isHubHud ? "linear-gradient(180deg, rgba(132,66,28,0.92), rgba(36,18,12,0.96))" : "rgba(255,170,122,0.12)",
        boxShadow: isHubHud ? chipBase.boxShadow : "0 0 0 1px rgba(255,170,122,0.10) inset",
      },
    ...
    wrap.appendChild(make("div", {
      ...
      style: {
        ...
        background: isHubHud ? "linear-gradient(180deg, rgba(56,86,132,0.92), rgba(12,20,34,0.96))" : "rgba(159,214,255,0.12)",
        boxShadow: isHubHud ? chipBase.boxShadow : "0 0 0 1px rgba(159,214,255,0.10) inset",
      },

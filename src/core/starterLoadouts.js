export const SKILL_ROUTE_META = {
  ...
  energyBomb: { route: 'electric', role: 'fused electric bomb', style: 'big shock detonation' },
  ...
  fireBomb: { route: 'fire', role: 'fused fire bomb', style: 'burn explosion' },
  ...
  iceBomb: { route: 'ice', role: 'fused ice bomb', style: 'freeze burst' },

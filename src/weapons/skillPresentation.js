const SKILL_INFO = {
  ...
  rockets: {
    ...
    what: 'Evolved gun form: explosive rockets instead of the base gun route.',
  ...
  energyBomb: {
    ...
    what: 'Evolved electric form that explodes and chains bonus zap damage.',
  ...
  fireBomb: {
    ...
    what: 'Evolved fire form that explodes and leaves strong burn damage.',
  ...
  iceBomb: {
    ...
    what: 'Evolved ice form that explodes and heavily slows nearby enemies.',
